...
require_once($CFG->dirroot . '/mod/collaborativefolders/backup/moodle2/backup_collaborativefolders_stepslib.php');
...
class backup_collaborativefolders_activity_task extends backup_activity_task {
    ...
    static public function encode_content_links($content) {
        ...
        // Link to the list of collaborativefolderss.
        $search = '/('.$base.'\/mod\/collaborativefolders\/index.php\?id\=)([0-9]+)/';
        $content = preg_replace($search, '$@COLLABORATIVEFOLDERSINDEX*$2@$', $content);

        // Link to collaborativefolders view by moduleid.
        $search = '/('.$base.'\/mod\/collaborativefolders\/view.php\?id\=)([0-9]+)/';
        $content = preg_replace($search, '$@COLLABORATIVEFOLDERSVIEWBYID*$2@$', $content);

...
/// Parameters
$collaborativefolders_id   = required_param('repo_id', PARAM_INT); // Repository ID
...
$collaborativefolder = $DB->get_record($collaborativefolders, array('id' => $collaborativefolders_id), '*', MUST_EXIST);

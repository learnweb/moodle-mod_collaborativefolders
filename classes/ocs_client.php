 ...
 * based on repository_nextcloud\ocs_client.
 * Actually identical to that, but cloned here in order to maintain support for Moodle 3.5. Once M3.5 support is not required
 * anymore, this class can probably be substituted for repository_nextcloud\ocs_client.
 *
